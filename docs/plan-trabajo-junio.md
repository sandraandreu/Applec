...
> **Notas para semana 4:**
> - Al conectar asistencia (T12), cambiar el badge de estado del evento en el detalle por el badge de respuesta del miembro ("Confirmado" / "Sin respuesta" / "No voy"). Admin y organizador siguen viendo el estado del evento.
> - La página de lista de asistentes (T13) debe incluir: secciones ordenadas (Van / No van / Pendientes), link "Ver detalle de respuestas" desde el detalle del evento, y gráfica circular (quesito) con los porcentajes de votos.
